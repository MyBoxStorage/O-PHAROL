      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          <h2 className="section-title" style={{ color: 'var(--navy)' }}>
            {t.location.heading}{' '}
            <em style={{ color: 'var(--red)', fontStyle: 'italic' }}>{t.location.headingEm}</em>
          </h2>
            ...
            <div style={{ background: 'var(--navy)', position: 'relative', overflow: 'hidden' }}>
              ...
              <div style={{ padding: '32px 36px' }}>
                ...
                <div style={{ marginBottom: 26 }}>
                  ...
                  {t.location.schedule.map(({ day, time }) => (
                    <div key={`${day}-${time}`} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '7px 0', borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
